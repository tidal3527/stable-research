...
const features: Feature[] = [
  {
    ...
    icon: require("@site/static/icons/bank.svg").default,
    description: (
      <>
  ...
  },
  {
    ...
    icon: require("@site/static/icons/government.svg").default,
    description: (
      <>
  ...
  },
  {
    ...
    icon: require("@site/static/icons/bitcoin-svg.svg").default,
    description: (
      <>
  ...
  },
  {
    ...
    icon: require("@site/static/icons/trader.svg").default,
    description: (
  ...
  },
  {
    ...
    icon: require("@site/static/icons/media.svg").default,
    description: (
  ...
  },
  {
    ...
    icon: require("@site/static/icons/coffee2.svg").default,
    description: (
      <>
    ...
    <section className="tw-py-24 lg:tw-px-8">
      <div className="tw-max-w-7xl tw-mx-auto lg:tw-grid lg:tw-grid-cols-2 lg:tw-gap-20 lg:tw-items-center">
        <div className="tw-p-4">
          ...
          We adapt our research to match your goals and expertise.
          </p>
